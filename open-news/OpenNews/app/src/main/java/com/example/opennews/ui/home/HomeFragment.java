...
public class HomeFragment extends Fragment implements ArticleClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        pb = root.findViewById(R.id.pb_main);
        pb.setVisibility(View.VISIBLE);
        rv.setLayoutManager(new LinearLayoutManager(getContext()));
        mAdapter = new ArticlesViewAdapter(getActivity().getApplicationContext(),"headlines", this);
