package com.example.opennews.ui.entertainment;
...
public class EntertainmentFragment extends Fragment implements ArticleClickListener {

    private EntertainmentViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModel =
                ViewModelProviders.of(this).get(EntertainmentViewModel.class);
        ...
        mAdapter = new ArticlesViewAdapter(getActivity().getApplicationContext(), "entertainment", this);
