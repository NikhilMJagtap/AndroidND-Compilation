...
public class SportsFragment extends Fragment implements ArticleClickListener {

    private SportsViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mAdapter = new ArticlesViewAdapter(getActivity().getApplicationContext(), "sports", this);
