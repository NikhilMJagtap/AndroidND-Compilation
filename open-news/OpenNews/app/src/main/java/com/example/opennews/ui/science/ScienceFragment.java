package com.example.opennews.ui.science;
...
public class ScienceFragment extends Fragment implements ArticleClickListener {

    private ScienceViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModel =
                ViewModelProviders.of(this).get(ScienceViewModel.class);
        ...
        mAdapter = new ArticlesViewAdapter(getActivity().getApplicationContext(), "science", this);
